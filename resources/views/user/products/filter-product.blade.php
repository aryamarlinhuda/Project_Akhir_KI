...
@section('judul_halaman','Filter Product | User')
@section('product','active')
@section('user.filter-category')
    ...
    <div class="col-sm-3 mb-4">
        <div class="btn-group">
            ...
            <ul class="dropdown-menu">
                ...
                <li><a class="dropdown-item" href="{{ url('user/product/'.$category->category) }}">{{ $category->category }}</a></li>
                @endforeach
            </ul>
        </div>
    </div>
